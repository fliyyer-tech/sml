...
const HeaderDesktop = () => {
  return (
    <div
      className="hidden md:flex w-full h-[90vh] bg-cover bg-center relative"
    ...
    >
      ...
      <div className="w-full max-w-7xl mx-auto flex flex-col justify-between relative">
        <h1 className="text-4xl max-w-80 md:leading-[70px] md:text-6xl font-bold text-white absolute left-0 top-1/2 transform -translate-y-1/2">
          Unveiling the Soul of the City
        </h1>
        <p className="text-lg text-white absolute right-0 bottom-14 max-w-md text-right">
